  ...
  return (
    <div>
      ...
      <div className="flex">
        ...
        <button
          className="px-4 border-1 "
          onClick={() => setCurrentPage(totalP - 2)}
          disabled={currentPage == totalP - 2 ? true : false}
        >
          {totalP - 2}
        </button>
        <button
          className="px-4 border-1 "
          onClick={() => setCurrentPage(totalP - 1)}
          disabled={currentPage == totalP - 1 ? true : false}
        >
          {totalP - 1}
        </button>
        <button
        ...
        {/* <button
          className="px-4 border-1 "
          onClick={next}
          disabled={nextP == null ? true : false}
        >
          next{" "}
        </button> */}
        {!loading && data?.characters.info.next && (
          <button onClick={next} disabled={nextP == null ? true : false}>
            next
          </button>
        )}
      </div>
